...
const finishingDaboardWipServices = require('../../services/finishing_dashboard_services/finishing_dashboard_wip_services');
...
const controller = async(req, res) => {
    try {
        ...
        const data = await finishingDaboardWipServices(req.query);
        if (data) {
