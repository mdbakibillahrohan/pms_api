...
const finishingDashboardAllServices = require('../../services/finishing_dashboard_services/finishing_dashboard_all_services');
...
const controller = async(req, res) => {
    try {
        ...
        const data = await finishingDashboardAllServices(req.query);
        if (data) {
