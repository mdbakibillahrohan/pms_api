...
const totalRejectionPercentageServices = require('../../services/finishing_dashboard_services/total_rejection_percentage_services');
...
const controller = async(req, res) => {
    try {
        ...
        const data = await totalRejectionPercentageServices(req.query);
        if (data) {
