...
const tender_user_password_reset_services = require('../../../services/tender/tender_user_password_reset/tender_user_password_reset_services');
...
const controller = async (req, res) => {
    try {
        ...
        const data = await tender_user_password_reset_services(req.body);
