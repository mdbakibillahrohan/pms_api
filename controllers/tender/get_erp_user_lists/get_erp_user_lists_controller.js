...
const getErpUserListsServices = require('../../../services/tender/get_erp_user_lists/get_erp_user_lists_services');
...
const controller = async(req, res) => {
    try {
        const data = await getErpUserListsServices(req.query);
        if (data) {
