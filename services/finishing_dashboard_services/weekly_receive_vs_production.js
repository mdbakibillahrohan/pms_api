...
const weeklyReceiveVsProductionServices = async(payload)=>{
    const data = await getWeeklyReceiveVsProductionData(payload);
    return data;
}

const getWeeklyReceiveVsProductionData = async (payload)=>{
...
module.exports = weeklyReceiveVsProductionServices;