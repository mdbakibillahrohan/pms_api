...
washDashboardRouter.get(
  API.API_CONTEXT + API.WASH_DASHBOARD_DATA_TOTAL_RECEIVE_GMT,
...
washDashboardRouter.get(
  API.API_CONTEXT + API.WASH_DASHBOARD_DATA_TOTAL_DELIVERY,
...
washDashboardRouter.get(
  API.API_CONTEXT + API.WASH_DASHBOARD_DATA_TOTAL_PRODUCTION,
...
washDashboardRouter.get(
  API.API_CONTEXT + API.WASH_DASHBOARD_DATA_THIS_MONTH_TOTAL_PRODUCTION,
...
washDashboardRouter.get(
  API.API_CONTEXT + API.WASH_DASHBOARD_DATA_TOTAL_REJECTION_PERCENTAGE,
...
washDashboardRouter.get(
  API.API_CONTEXT + API.WASH_DASHBOARD_DATA_WIP,
...
washDashboardRouter.get(
  API.API_CONTEXT + API.WASH_DASHBOARD_DATA_WEEKLY_RECEIVE_VS_DELIVER,
  validator(weekReceiveVsDeliverySchema, 'query'),
  weekReceiveVsDeliveryController
);
washDashboardRouter.get(
  API.API_CONTEXT + API.WASH_DASHBOARD_DATA_STYLE_WISE_RECEIVE_VS_DELIVERY,
